...
CATEGORY_RULES = {
    ...
    "games": {
        "strong_keywords": [r"\bps5\b", r"\bplaystation\b", r"\bxbox\b", r"\bnintendo\b", r"\bswitch\b", r"\bdualshock\b", r"\bdualsense\b"],
    ...
    "esportes": {
        ...
        "ambiguous_brands": [r"\bnike\b", r"\badidas\b", r"\bpuma\b", r"\bunder armour\b", r"\basics\b", r"\bmizuno\b", r"\bpenalty\b"],
...
OFFER_PATTERNS: dict[str, list[re.Pattern]] = {
    ...
    "link": [re.compile(p, re.IGNORECASE) for p in [
        r"https?://",
        r"amzn\.to",
        r"magalu\.at",
        r"mercadolivre\.com",
...
def _clean_product_name(text: str) -> str:
    ...
    triggers = [
        ...
        r"QUERIA COMPRAR ESSE MAS JA TA RESERVADO", r"MULHERES CHEIROSAS USAM ESSE",
        r"JA PODE PARAR DE SENTAR NO CHAO", r"CAPAZ DA TUA COLUNA TE ABRACAR",
        r"AMAZON SOLTOU CUPOM", r"PRA VC NAO VIRAR UM NAPOLITANO NO SOL",
        r"PODE APOSENTAR SUAS MEIAS FURADAS", r"NA FARMACIA ISSO CUSTA UM RIM",
        r"SEU NOVO UNIFORME PRA TREINAR", r"AGORA SO FALTA A PASSAGEM",
        r"GARANTO QUE UM DESSE E MUITO UTIL NA COZINHA", r"QUEM GOSTA DE FIO E ELETRICISTA",
        r"TA NA HORA DE TIRAR O MONITOR DO CHAO", r"ISSO AQUI E UMA MAO NA RODA"
    ]
